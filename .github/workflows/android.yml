...
jobs:
  build:
    ...
    - name: Configure Build Files
      run: |
        # --- STEP 1: Configure the Game Module (src/Android.mk) ---
        ...
        # Point to the SDL include folder (Up one level, then into SDL/include)
        echo 'LOCAL_C_INCLUDES := $(LOCAL_PATH)/../SDL/include' >> Android.mk
        ...
        # --- STEP 2: Configure the Root Loader (jni/Android.mk) ---
        # This fixes the "undefined module" error by forcing SDL to load
        cd ..
        
        echo 'LOCAL_PATH := $(call my-dir)' > Android.mk
        # Explicitly include SDL2's makefile first
        echo 'include $(LOCAL_PATH)/SDL/Android.mk' >> Android.mk
        # Then include our game's makefile
        echo 'include $(LOCAL_PATH)/src/Android.mk' >> Android.mk
        
        # --- STEP 3: Configure Application.mk ---
